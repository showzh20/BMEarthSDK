...
#ifndef BM_GRAPHICSWINDOWCOCOA
#define BM_GRAPHICSWINDOWCOCOA 1


#ifdef __OBJC__
@class BmGraphicsWindowIOSWindow;
@class BmGraphicsWindowIOSGLView;
@class BmGraphicsWindowIOSGLViewController;
@class EAGLContext;
@class UIWindow;
@class UIView;
 ...
 */
class BmGraphicsWindowIOS : public osgViewer::GraphicsWindow
{
    public:
        class Implementation;
    
        static osg::Timer* BmTimer ;//用来记录轨迹行走拖动视图的timer

        BmGraphicsWindowIOS(void* traits) : GraphicsWindow(),
            _valid(false),
            _initialized(false),
            _realized(false),
            _window(NULL),
        ...
        {
            _traits = static_cast<osg::GraphicsContext::Traits*>(traits);
        ...
        virtual bool isSameKindAs(const Object* object) const { return dynamic_cast<const BmGraphicsWindowIOS*>(object)!=0; }
        virtual const char* libraryName() const { return "osgViewer"; }
        virtual const char* className() const { return "BmGraphicsWindowIOS"; }
        ...
        class WindowData : public osg::Referenced
        {
            ...
            friend class BmGraphicsWindowIOS;

        };
        
        EAGLContext* getContext() { return _context; }
        BmGraphicsWindowIOSWindow* getWindow() { return _window; }
        BmGraphicsWindowIOSGLView* getView() { return _view; }
    ...
    private:        
        ...
        BmGraphicsWindowIOSWindow*           _window;
        BmGraphicsWindowIOSGLView*           _view;
        BmGraphicsWindowIOSGLViewController* _viewController;
